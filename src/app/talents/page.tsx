                ...
                header={
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <h3 className="mt-1 text-base font-semibold">{talent.name}</h3>
                      <p className="mt-1 line-clamp-2 text-sm text-[var(--app-muted)]">{talent.headline}</p>
                    </div>
                  </div>
                }
                body={
                  <div className="space-y-3">
                    <div className="grid gap-3">
                      <div className="rounded-2xl border border-[var(--app-border)] bg-black/10 p-3 dark:bg-white/5">
                        ...
                        <p className="mt-2 line-clamp-2 text-sm font-medium">{campusNameById(talent.campusId)}</p>
                      </div>
                    </div>
